...
const generalBusinessAccounts: readonly StarterAccount[] = Object.freeze([
  ...
  { code: '1010', name: 'Bank account - operating', type: 'ASSET', normalBalance: d },
  ...
  { code: '1100', name: 'Trade receivables', type: 'ASSET', normalBalance: d },
  ...
  { code: '1200', name: 'Inventory', type: 'ASSET', normalBalance: d },
  { code: '1300', name: 'Prepaid expenses', type: 'ASSET', normalBalance: d },
  { code: '1400', name: 'Input tax recoverable', type: 'ASSET', normalBalance: d },
  ...
  { code: '2000', name: 'Trade payables', type: 'LIABILITY', normalBalance: c },
  ...
  { code: '2050', name: 'Output tax payable', type: 'LIABILITY', normalBalance: c },
  ...
  { code: '3030', name: 'Retained earnings', type: 'EQUITY', normalBalance: c },
  { code: '3040', name: 'Current year earnings', type: 'EQUITY', normalBalance: c },
  { code: '4000', name: 'Sales revenue', type: 'REVENUE', normalBalance: c },
  ...
  { code: '5190', name: 'Miscellaneous expense', type: 'EXPENSE', normalBalance: d },
  { code: '6000', name: 'Cost of goods sold', type: 'COST_OF_SALES', normalBalance: d },
  ...
  { code: '7010', name: 'Foreign exchange gain', type: 'OTHER_INCOME', normalBalance: c },
  { code: '7100', name: 'Interest expense', type: 'OTHER_EXPENSE', normalBalance: d },
  { code: '7110', name: 'Foreign exchange loss', type: 'OTHER_EXPENSE', normalBalance: d },
]);
